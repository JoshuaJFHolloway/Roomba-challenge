        ...
        <div>
            ...
            <form onSubmit={props.onSubmit}>
                ...
                <div className='numberInput'>
                    <input type="number" name="length" min="1" placeholder="Enter room length" onChange={props.onChange} required/>
                    <input type="number" name="width" min="1" placeholder="Enter room width" onChange={props.onChange} required/>
                </div>
